...
RequestBody  ecorrRequestBody = RequestBody.create(MediaType.parse("application/json"), '{"messageType":"email","sender":{"replyTo":"","alias":"","email":""},"messageFormat":"text","recipients":[{"recipientType":"to","email":""}],"applicationId":"DUMMY","content":{"items":[{"templateType":"text","index":0,"text":"DUMMY","contentType":"emailSubject"},{"templateType":"text","index":1,"text":"DUMMY DUMMY DUMMY","contentType":"emailBody"}]}}')
