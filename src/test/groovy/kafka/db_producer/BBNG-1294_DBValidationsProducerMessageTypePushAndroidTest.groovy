...
if(rs.next()){
    ...
    String appIdType = sharedData.getString("appIdType")
    String triggeringEvent = sharedData.getString("triggeringEvent")
    ...
    if (originalEventId.equals(eventCorrelationId)) {
        ...
        softly.assertThat(appIdType).isEqualTo("androidAppId")
        softly.assertThat(triggeringEvent).isEqualTo("onsuccess")
        softly.assertThat(triggeredTemplate).isEqualTo("dc-orch-ebill-push-android")
        softly.assertThat(originalMessageType).isEqualTo(messageType)
