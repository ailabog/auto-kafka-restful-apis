...
RequestBody  ecorrRequestBody = RequestBody.create(MediaType.parse("application/json"), '{"messageType":"email","sender":{"replyTo":"","alias":"","email":""},"messageFormat":"text","recipients":[{"recipientType":"to","email":""}],"applicationId":"","content":{"items":[{"templateType":"text","index":0,"text":"+351212111333","contentType":"emailSubject"},{"templateType":"text","index":1,"text":"O Porto é, frequentemente, referido como a cidade portuguesa com o temperamento mais centro-europeu, devido ao bucolismo requintado do seu espaço urbano.","contentType":"emailBody"}]}}')
...
JSONObject requestPayloadJson = new JSONObject('{"messageType":"email","sender":{"replyTo":"","alias":"","email":""},"messageFormat":"text","recipients":[{"recipientType":"to","email":""}],"applicationId":"","content":{"items":[{"templateType":"text","index":0,"text":"+351212111333","contentType":"emailSubject"},{"templateType":"text","index":1,"text":"O Porto é, frequentemente, referido como a cidade portuguesa com o temperamento mais centro-europeu, devido ao bucolismo requintado do seu espaço urbano.","contentType":"emailBody"}]}}')
...
if(emailCount == 1 && smsCount == 0){
    log.info("Only one email record found into the db")
} else {
    log.info("Something went wrong into the db")
}
