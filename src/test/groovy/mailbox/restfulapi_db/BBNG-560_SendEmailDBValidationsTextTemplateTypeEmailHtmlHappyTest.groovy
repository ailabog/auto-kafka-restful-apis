...
RequestBody  ecorrRequestBody = RequestBody.create(MediaType.parse("application/json"), '{"messageType":"email","sender":{"replyTo":"","alias":"","email":""},"messageFormat":"text","recipients":[{"recipientType":"to","email":""}],"applicationId":"","content":{"items":[{"templateType":"html","index":0,"text":"+12672133096","contentType":"emailSubject"},{"templateType":"html","index":1,"text":"Automated email sent with success today format type text  and subject and body html","contentType":"emailBody"}]}}')
...
JSONObject requestPayloadJson = new JSONObject('{"messageType":"email","sender":{"replyTo":"","alias":"","email":""},"messageFormat":"text","recipients":[{"recipientType":"to","email":""}],"applicationId":"","content":{"items":[{"templateType":"htm","index":0,"text":"+12672133096","contentType":"emailSubject"},{"templateType":"html","index":1,"text":"Automated email sent with success today format type text  and subject and body htmlt","contentType":"emailBody"}]}}')
