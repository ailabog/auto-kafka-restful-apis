...
eventBody.put("Primary_Holding_ID1", new GenericData.Array<>(avroSchemaEbill.getField("eventBody").schema().getField("Primary_Holding_ID1").schema(), Arrays.asList("00000000000009453067")))
...
log.info(" message produced: " + eventHeader.toString() + eventBody.toString())
