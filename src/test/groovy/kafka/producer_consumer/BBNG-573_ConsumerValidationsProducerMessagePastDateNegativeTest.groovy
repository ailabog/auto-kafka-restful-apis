...
log.info("Producing valid message on topic: " + topicProducer)
...
log.info("Validating the Consumer fields against the fields produced with document type:" + datePast + "... with success")
