...
if(rs.next()){
    ...
    if (originalEventId.equals(eventCorrelationId)) {
        ...
        softly.assertThat(triggeredTemplate).isEqualTo("customer-push-notification-success-event-msg")
        ...
        softly.assertThat(originalEventInitiatorDescription).isEqualTo("ush notifications")
        softly.assertThat(policyNumber).isEqualTo(primaryHoldingID)
        //softly.assertThat(userId).isEqualTo(userId)
        softly.assertThat(originalEventSourceDescription).isEqualTo("EBill push notifications")
        ...
        softly.assertThat(policyNumber).isEqualTo(primaryHoldingID)
        softly.assertThat(originalEventInitiator).isEqualTo("")
        softly.assertThat(fileName).isEqualTo("customer-push-notification-success-event-info")
